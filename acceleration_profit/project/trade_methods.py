class TradeMethods:
    ...
    def change_profit_percentage(self, btc_trades_number, busd_trades_number, profit_percentage, profit_step):
    ...
    def check_for_split(self, btc_total_init, btc_qty, btc_reached_profit, busd_total_init, busd_qty, busd_reached_profit,
                        curr_price, profit_level):
        # if busd_trades_number < 0 and busd_trades_number % 4 == 0:
        #     return True, 'BUSD'
        # elif btc_trades_number < 0 and btc_trades_number % 4 == 0:
        #     return True, 'BTC'
        # return False, ''
        ...
        if (curr_btc_overall/btc_total_init -1)*100> btc_reached_profit + profit_level \
                and (curr_busd_overall/btc_total_init -1 )*100> busd_reached_profit + profit_level:
            btc_reached_profit = (curr_btc_overall/btc_total_init -1)*100
            busd_reached_profit = (curr_busd_overall/btc_total_init -1 )*100
