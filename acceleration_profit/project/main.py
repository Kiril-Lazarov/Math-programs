...
while True:
    ...
    btc.btc_profit_percentage, busd.busd_profit_percentage = access.change_profit_percentage(btc.btc_trades_number,
                                                                                             busd.busd_trades_number,
                                                                                             profit_percentage,
                                                                                             profit_step)
